...
- CI gate Stage 7 berubah menjadi manual-only: workflow Playwright E2E dipertahankan hanya untuk eksekusi on-demand agar tidak menghasilkan noise email (`.github/workflows/e2e-role-flow.yml`).
...
- E2E CI workflow (manual only): `.github/workflows/e2e-role-flow.yml`
